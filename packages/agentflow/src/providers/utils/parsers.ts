...
export function parseAsTaggedJson(output: string): unknown {
  const open = output.match(/<(?:tool_call|function_call|tool_use)>|\[TOOL_CALL\]/i);
...
export function stripThinkTags(text: string): string {
  const TAG_PATTERN = "think|thinking|reasoning|thought|reasoning_scratchpad";
